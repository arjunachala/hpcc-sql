...
public class Main {
    ...
    public static void main(String[] args) throws Exception  {
        ...
        String statement2 = "SELECT mytable1.firstname, mytable2.lastname, SUM(mytable2.age) FROM schema.mytable1, schema.mytable2, schema.mytable3 where mytable1.id=mytable2.id";

        String statement3 = "SELECT mytable1.firstname, mytable2.lastname,  FROM (schema.mytable1 left outer join schema.mytable2 on mytable1.id=mytable2.id) left outer join schema.mytable3 on schema.mytable1.id=schema.mytable3";
